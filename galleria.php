...
function galleria_init() {
  wp_enqueue_script('jquery');
	wp_enqueue_script('galleria', WP_PLUGIN_URL.'/lc-galleria/galleria/galleria.js', 'jquery');
	wp_enqueue_script('galleria_flickr', WP_PLUGIN_URL.'/lc-galleria/galleria/plugins/galleria.flickr.js', 'galleria');
